...
RSpec.describe Dependabot::Gradle::FileParser do
  ...
  describe "parse" do
    ...
    context "with a version using two properties" do
      let(:buildfile_fixture_name) { "concatenated_properties.gradle.kts" }
    ...
    context "with a missing property" do
      let(:buildfile_fixture_name) { "missing_property.gradle.kts" }
    ...
    context "with an import" do
      let(:buildfile_fixture_name) { "with_import_build.gradle.kts" }
    ...
    context "with a dependencyVerification section" do
      let(:buildfile_fixture_name) { "gradle_witness.gradle.kts" }
    ...
    context "specified as implementations" do
      let(:buildfile_fixture_name) { "android_build.gradle.kts" }
    ...
    context "with a nested constraint" do
      let(:buildfile_fixture_name) { "nested_constraint_build.gradle.kts" }
